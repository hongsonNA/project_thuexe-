                                    ...
                                    <div class="row" style="padding-bottom: 20px;">
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="" placeholder="Lamboghini">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Gia cho thue</label>
                                                <input type="number" name="price" class="form-control" id="" placeholder="500.000">
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="">So cho </label>
                                                    <input type="number" name="seat" class="form-control" id="" placeholder="VD: xe 4 cho" value="" >
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="">Model </label>
                                                    <input type="number" name="model_id" class="form-control" id="" placeholder="" value="" >
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="">Danh muc</label>
                                                    <select  class="form-control" name="cate_id">
                                                        @foreach($category as $key => $cate)
                                                        <option name=""  value="{{ $cate->id }}">{{ $cate->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" class="form-control" id="" placeholder="500.000">
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="form-group">
