                                ...
                                @if($m->user_id == Auth::user()->id)
                                    @if($m->status === 2 && $m->is_trash == 0 )
                                        <tr>
                                            ...
                                            <td>
                                                <img
                                                    src="/image_upload/img_vehicle/{{ $m['image_vehicle']['image_vehicle'] }}"
                                                    style="width: 100px">
                                            </td>
                                            ...
                                            <td class="text-right">
                                                <a target="_blank" href="{{ route('detail', $m['id']) }}"
                                                   class="btn btn-success">Xem chi tiết</a>
                                                <a href="{{ route('moveTrash', $m['id']) }}" class="btn btn-danger">Ngưng
                                                    hoạt động</a>
